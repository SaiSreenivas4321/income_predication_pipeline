...
from src.pipeline.predication_pipeline import PredicationPipeline,CustomClass
...
def predicate_date():
    ...
    pipeline_predication = PredicationPipeline()
    ...
    if result == 0:
        ...
        return render_template("results.html",final_result = "Your Yearly income is more than  than equal to >50k:{}".format(result) )
